...
public class GamePart extends AppCompatActivity {
    ...
    public void playAgain(View view) {
        ...
        timeOutImageView.animate().alpha(0).setDuration(100);
        score = 0;
        numberOfQuestions = 0;
        ...
        new CountDownTimer(30100,1000) {
            ...
            public void onFinish() {
                ...
                waitImageView.setVisibility(View.INVISIBLE);
                timeOutImageView.animate().alpha(1).setDuration(1000);
            }
        }.start();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timeOutImageView = findViewById(R.id.timeOutImageView);
        timeOutImageView.animate().alpha(0);
